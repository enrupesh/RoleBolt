...
export const productKeywords = {
  ...
  solutions: [
    ...
    "Link Pulse solutions",
    "URL shortener for agencies",
    "URL shortener for content creators",
    "URL shortener for ecommerce brands",
    "link tracking for digital marketers",
    "bio link page for Instagram",
    "Sales Dashboard solutions",
    "retail sales analytics solutions",
    "sales tracking for retail stores",
    "sales analytics for ecommerce brands",
    "sales analytics for wholesale businesses",
    "free AI tools India 2026",
    "best free AI platform India",
  ...
  budget: [
    ...
    "AI budget app",
    "free budget tracker app",
    "free budget planner app",
    "free monthly budget tracker",
    "free personal budget app",
    "free budget app no ads",
    "budget tracker free no signup",
    "student budget app",
    "student budget app free",
    "student budget planner free",
    "student expense tracker free",
    "college student budget app",
    "university student budget app",
    "budget app for students India",
    ...
    "free spending tracker app",
    "subscription tracker AI",
    "forgotten subscription tracker",
    "AI subscription finder",
    "AI recurring expense tracker",
    "AI category budgeting",
    "AI spend categorization",
    "AI budget categories",
    "AI 50 30 20 rule",
    "envelope budgeting AI",
    "zero based budgeting AI",
    "AI budget forecast",
    "AI budget analytics",
    "AI budget dashboard",
    "budget insights AI",
    ...
    "free Mint alternative 2025",
    "free YNAB alternative 2025",
    "best free budget app 2025",
    "best free budget app 2026",
    "best budget app India 2025",
    "best AI budget tracker 2026",
    "budget tracker India free",
    "AI budget tracker India",
    "budget tracker in rupees",
    "INR budget tracker",
    "Indian budget planner app",
    "budget app for Indian students",
    "budget app for salaried person India",
    "budget app for freelancers India",
    "AI budget for gig workers",
    "AI budget for freelancers",
    "AI budget for entrepreneurs",
    "AI budget for young professionals",
    "AI budget for couples",
    "AI budget for families",
    "how to track expenses with AI",
    "how to save money with AI app",
    "how to budget monthly with AI",
    "how to reduce spending with AI",
    "how to reach savings goal with AI",
  ],
  ...
  salesAi: [
    ...
    "free AI SDR",
    "free AI sales tool",
    "free AI outreach tool",
    "free sales AI no credit card",
    "AI cold email",
    "AI cold email tool",
    ...
    "AI email outreach free",
    "AI Gmail outreach",
    "Gmail AI outreach",
    "send cold email through Gmail AI",
    "Gmail cold email tool",
    "AI lead outreach",
    "AI lead email",
    ...
    "AI follow-up sales email",
    "AI pipeline tool",
    "AI sales pipeline",
    "AI sales pipeline builder",
    "AI prospect email",
    "AI prospecting tool",
    "AI prospecting email",
    "AI B2B outreach",
    "B2B cold email AI",
    "B2B sales AI free",
    "AI for SaaS sales",
    "SaaS cold email AI",
    "AI for startup sales",
    "startup sales tool free",
    "AI for solo founders",
    "AI for small sales teams",
    "AI for SDRs",
    "AI for BDRs",
    "AI for account executives",
    "AI for sales reps",
    "AI for consultants sales",
    "AI sales for agencies",
    "AI sales for freelancers",
    "Lemlist alternative free",
    "Instantly alternative free",
    "Apollo alternative free",
    "Hunter.io alternative free",
    "Snov.io alternative free",
    "Mailshake alternative free",
    "Woodpecker alternative free",
    "Reply.io alternative free",
    "free Lemlist alternative",
    "free Instantly alternative",
    "free Apollo alternative",
    "best free AI cold email tool 2025",
    "best AI cold email tool 2026",
    "best free SDR tool 2025",
    "best AI sales tool for startups 2026",
    "CSV upload cold email AI",
    "bulk cold email AI personalization",
    "AI cold email India",
    "AI sales tool India",
    "cold email tool India free",
    "how to write cold emails with AI",
    "how to personalize cold emails at scale",
    "how to automate sales outreach with AI",
    "how to send cold emails from Gmail AI",
  ],
  linkPulse: [
    "Link Pulse",
    "Rolebolt Link Pulse",
  ...
  salesDashboard: [
    ...
    "BI dashboard free",
    "free sales analytics 2025",
    "free sales reporting 2026",
    ...
    "retail sales India analytics",
    "Power BI alternative free",
    "Tableau alternative free",
    "sales dashboard for small business",
    "how to track retail sales online",
    "how to analyze sales by region",
    "how to create a sales report free",
    "sales dashboard INR",
  ],
} as const;
...
export function softwareApplicationJsonLd() {
  return {
    ...
    featureList: [
      ...
      "Bihar AI — regional assistant in Hindi, Bhojpuri, Maithili, Magahi",
      "Smart Ledger — handwritten satti accounting for grain traders",
