/** Structured profile data — designed for Phase 4 NVIDIA structuring + theme rendering. */
...
export type SitegenCreatorPortfolioLink = {
  title: string;
  url: string;
};

export type SitegenCreatorTeamMember = {
  name: string;
  role?: string;
  bio?: string;
};
